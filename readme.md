...
|------|------|------|
| `1.측정인 자동입력 V2.8.bat` | `eco_input_gui.py` | 측정인.kr 자동 입력, 백데이터, 탭4 PDF 처리 |
...
| `5.성적서 검토 V2.7.bat` | `report_check_gui.py` | 성적서 파일 자체 무결성 검사 |
...
- 실행은 `.bat` 파일을 더블클릭
- 자동입력은 `1.측정인 자동입력 V2.8.bat`
- 성적서 검토는 `5.성적서 검토 V2.7.bat`
